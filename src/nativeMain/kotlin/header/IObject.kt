...
//    fun <VTableItems> addVTable(vararg items: VTableItems): VTableAdder
...
//     */
////    template < typename... VTableItems , typename = std::enable_if_t<(is_one_of_variants_types<VTableItem, std::decay_t<VTableItems>> && ...)> >
//    fun <VTableItems> addVTable(interfaceName: InterfaceName, vararg items: VTableItems);
...
//template <typename... VTableItems, typename>
//fun IObject.addVTable(VTableItems&&... items): VTableAdder
//{
//    return addVTable(List<VTableItem>{std::forward<VTableItems>(items)...});
//}
