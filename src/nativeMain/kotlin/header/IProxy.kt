...
inline fun IProxy.callMethod(message: MethodCall, timeout: Duration): MethodReply {
    return callMethod(message, timeout.inWholeMicroseconds.toULong());
}
...
inline fun IProxy.callMethodAsync(
    ...
    return callMethodAsync(message, asyncReplyCallback, timeout.inWholeMicroseconds.toULong());
}
...
inline suspend fun IProxy.callMethodAsync(
    message: MethodCall,
    timeout: Duration,
    with_future: with_future_t
): MethodReply {
    return callMethodAsync(message, timeout.inWholeMicroseconds.toULong(), with_future);
}
...
inline fun IProxy.callMethodAsync(methodName: MethodName): AsyncMethodInvoker {
    return AsyncMethodInvoker(this@callMethodAsync, methodName)
}
...
inline fun IProxy.getProperty(propertyName: PropertyName): PropertyGetter {
    return PropertyGetter(this, propertyName.value);
}
...
inline fun IProxy.getPropertyAsync(propertyName: PropertyName): AsyncPropertyGetter {
    return AsyncPropertyGetter(this, propertyName.value);
}
...
inline fun IProxy.setProperty(propertyName: PropertyName): PropertySetter {
    return PropertySetter(this, propertyName.value);
}
...
inline fun IProxy.setPropertyAsync(propertyName: PropertyName): AsyncPropertySetter {
    return AsyncPropertySetter(this, propertyName.value);
}
 ...
 * @throws sdbus::Error in case of failure
 */
inline fun IProxy.getAllProperties(): AllPropertiesGetter {
...
inline fun IProxy.getAllPropertiesAsync(): AsyncAllPropertiesGetter {
