...
public class Adapter1Proxy(
  ...
  override val address: String by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Address")) 

  override val addressType: String by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("AddressType")) 

  override val name: String by proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Name")) 

  override var alias: String by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Alias")) 

  override val `class`: UInt by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Class")) 

  override var powered: Boolean by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Powered")) 

  override var discoverable: Boolean by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Discoverable")) 

  override var discoverableTimeout: UInt by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("DiscoverableTimeout")) 

  override var pairable: Boolean by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Pairable")) 

  override var pairableTimeout: UInt by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("PairableTimeout")) 

  override val discovering: Boolean by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Discovering")) 

  override val uUIDs: List<String> by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("UUIDs")) 

  override val modalias: String by
      proxy.prop(Adapter1.Companion.INTERFACE_NAME, PropertyName("Modalias")) 
