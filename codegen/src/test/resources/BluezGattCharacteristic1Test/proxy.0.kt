...
public class GattCharacteristic1Proxy(
  ...
  override val uUID: String by proxy.prop(GattCharacteristic1.Companion.INTERFACE_NAME,
      PropertyName("UUID")) 
  ...
  override val writeAcquired: Boolean by proxy.prop(GattCharacteristic1.Companion.INTERFACE_NAME,
      PropertyName("WriteAcquired")) 

  override val notifyAcquired: Boolean by proxy.prop(GattCharacteristic1.Companion.INTERFACE_NAME,
      PropertyName("NotifyAcquired")) 

  public override fun register() {
  }

  override suspend fun readValue(options: Map<String, Variant>): List<UByte> =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME, MethodName("ReadValue")) {
    call(options)
  }

  override suspend fun writeValue(`value`: List<UByte>, options: Map<String, Variant>): Unit =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME, MethodName("WriteValue"))
      {
    call(value, options)
  }

  override suspend fun acquireWrite(options: Map<String, Variant>): AcquireType =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME,
      MethodName("AcquireWrite")) {
    call(options)
  }

  override suspend fun acquireNotify(options: Map<String, Variant>): AcquireType =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME,
      MethodName("AcquireNotify")) {
    call(options)
  }

  override suspend fun startNotify(): Unit =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME, MethodName("StartNotify"))
      {
    call()
  }

  override suspend fun stopNotify(): Unit =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME, MethodName("StopNotify"))
      {
    call()
  }

  override suspend fun confirm(): Unit =
      proxy.callMethodAsync(GattCharacteristic1.Companion.INTERFACE_NAME, MethodName("Confirm")) {
    call()
  }
}
